...
/**
* Classe reonsável por fazer todas as consultas 
* e modificações (relacionadas a Usuários) ao banco de dados.
* 
...
public class UsuarioDAO {
    ...
    public static boolean login(String login, String senha) throws SQLException{
        ...
        conecta.conexao();
        int cont = 0;
        String sql = "SELECT * FROM usuario WHERE user_usuario = '" + login + "' AND senha_usuario = '" + senha + "'"; //tabela do inicius é iss.usuario
