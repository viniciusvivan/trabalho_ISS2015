...
public class Rel_ReajusteFreteDAO {
    ...
    public static void ireport() {
        ...
        try {
            ...
            //JasperPrint jpPrint = JasperFillManager.fillReport("D:/Ciência da Computação/8º Termo/Implementação de Sistema de Softare/2º Trabalho/Gelly_Fruit_ISS/produtos.jasper",new HashMap(),relatResul);
