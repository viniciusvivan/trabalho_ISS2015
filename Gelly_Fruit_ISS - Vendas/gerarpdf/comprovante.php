...
?>
    ...
    <section>
        ...
        <h2 style="text-align: center; font-size: 25px">Comprovante de pagamento</h2>
        <hr>
        <h3>Código da compra: <b><?php echo $id_venda ?></b></h3>
        <h3>Cliente: <b><?php echo $nome ?></b></h3>
        <h4>Data de emissão: <b><?php echo $data_hora ?></b></h4>
        <table style="margin: auto">
            <tr><td colspan="4" style="font-size: 14pt; text-align: center; background-color: #2d2d2d; color: white"><b>Lista de produtos<b></td></tr>
            <tr>
                ...
                <td style="font-size: 13pt; text-align: center; background-color: #d5d5d5" colspan='1'><b>Valor</b></td>
            </tr>
            <?php
            ...
            <tr>
                ...
                <td width="150px" align="center" colspan="1" style="font-size: 13pt; background-color: #D5D5D5"><b>Total: <?php echo 'R$ '.number_format($total, 2, ',', '.') ?></td></b>
            </tr>
        </table>
    </section>
    </body>
